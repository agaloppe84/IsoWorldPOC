...
public extension GeneratorVersionTable {
    static let current = GeneratorVersionTable(entries: [
        ...
        GeneratorVersionEntry(domain: .rpgDNA, version: .v1),
        GeneratorVersionEntry(domain: .rpgRules, version: .v1),
        GeneratorVersionEntry(domain: .rpgFactions, version: .v1),
        GeneratorVersionEntry(domain: .rpgObjectives, version: .v1),
        GeneratorVersionEntry(domain: .rpgQuests, version: .v1),
        GeneratorVersionEntry(domain: .rpgLedger, version: .v1),
        GeneratorVersionEntry(domain: .settlements, version: .v1),
        GeneratorVersionEntry(domain: .settlementRecipes, version: .v1),
        GeneratorVersionEntry(domain: .settlementSites, version: .v1),
        GeneratorVersionEntry(domain: .buildingIntents, version: .v1),
        GeneratorVersionEntry(domain: .buildingFootprints, version: .v1),
        GeneratorVersionEntry(domain: .buildingMassing, version: .v1),
